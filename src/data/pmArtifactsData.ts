  ...
  prioritization: [
    {
      ...
      impact: 'high',
      effort: 'medium',
      rationale: 'Closes 14pt peak-reduction gap between best and worst sites',
    },
    {
      name: 'Gateway auto-recovery playbook',
      impact: 'high',
      effort: 'low',
      rationale: 'Fixes top CS complaint; mostly config, not new hardware',
    },
    {
      name: 'Multi-tenant admin portal',
      impact: 'medium',
      effort: 'high',
      rationale: 'Needed at 100+ sites but not blocking current KPI',
    },
    {
      name: 'Mobile app for electricians',
      impact: 'medium',
      effort: 'medium',
      rationale: 'Reduces commissioning errors; defer until template rollout complete',
    },
  ],
  roadmap: [
    {
